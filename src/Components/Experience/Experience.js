                ...
                <div className="col-12-md col-6-lg">
                  ...
                  <div className="educate rounded overflow-hidden">
                    {SchoolData.map((val,key)=>{
                      return(
                        <div key={key} className="card education display-f mb-3 w-100 p-3 pb-1 border-bottom" data-aos="flip-down">
                      <div className="symbol text-primary display-f justify-content-center">
                        <svg
                      ...
                      <div className="content mb-4 pl-3">
                        ...
                        {val.coursework?(
                        <p>
                          <strong>{val.subtitle}</strong>: {val.coursework.toString()}
                          </p>
                        ):(
                          null
                        )}
                ...
                <div className="col-12-md col-6-lg">
                  ...
                  <div className="educate rounded overflow-hidden">
                    {WorkData.map((val,key)=>{
                      return(
                        <div key={key} className="card education display-f mb-3 w-100 p-3 pb-1 border-bottom" data-aos="flip-down">
                      <div className="text-primary display-f justify-content-center">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="40"
                          height="40"
